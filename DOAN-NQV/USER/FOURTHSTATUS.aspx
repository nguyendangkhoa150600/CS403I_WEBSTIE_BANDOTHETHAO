<%@ Page Title="" Language="C#" MasterPageFile="~/SHARED/MP.Master" AutoEventWireup="true" CodeBehind="FOURTHSTATUS.aspx.cs" Inherits="DOAN_NQV.USER.FOURTHSTATUS" %>
     ...
     <div style="margin-top: 100px;">
           <div class="statusDH" style="width:100%;display:inline;">
            <div class="statusNAME" style="font-family:Tahoma;font-size:19px;text-decoration:none;margin-left:250px;height:40px;background-color:rgba(0, 0, 0, 0.26);width:950px;">
              <asp:LinkButton ID="LinkButton1" runat="server" href="DSDATHANG.aspx" class="tenTT" style="padding-right:100px;padding-left:38px;color:#111111;">Chờ duyệt</asp:LinkButton>
...
<%--                <asp:LinkButton ID="LinkButton3" runat="server"  class="tenTT" style="padding-right:100px;color:#111111;">Thanh toán</asp:LinkButton>--%>
                <asp:LinkButton ID="LinkButton4" runat="server"  href="FOURTHSTATUS.aspx" class="tenTT" style="padding-right:100px;color:#111111;color:#FFCC66;">Đã thanh toán</asp:LinkButton>
