<%@ Page Title="" Language="C#" MasterPageFile="~/SHARED/MP.Master" AutoEventWireup="true" CodeBehind="SECONDSTATUS.aspx.cs" Inherits="DOAN_NQV.USER.SECONDSTATUS" %>
      ...
      <div style="margin-top: 100px;">
           <div class="statusDH" style="width:100%;display:inline;">
            <div class="statusNAME" style="font-family:Tahoma;font-size:19px;text-decoration:none;margin-left:250px;height:40px;background-color:rgba(0, 0, 0, 0.26);width:950px;">
                ...
                <asp:LinkButton ID="LinkButton6" runat="server"  href="SECONDSTATUS.aspx" class="tenTT" style="padding-right:100px;color:#111111;color:#FFCC66;">Đã duyệt</asp:LinkButton>
