<%@ Page Title="" Language="C#" MasterPageFile="~/SHARED/MP.Master" AutoEventWireup="true" CodeBehind="XNDMK.aspx.cs" Inherits="DOAN_NQV.USER.XNDMK" %>
     ...
     <div class="container" style="height:420px;">
        <div class="row">
           ...
           <asp:Label ID="lbtb" runat="server" Text="" style="font-family:Tahoma;font-size:19px;margin-left:430px;text-align:center;position:relative;margin-top:10px;color:red;" Visible="false"></asp:Label>
             ...
             <asp:Button ID="btnconfirm" runat="server" OnClick="btnconfirm_Click" Text="Xác nhận" class="btn btn-danger" style="font-family:Tahoma;font-size:19px;margin-left:464px;margin-top:20px;width:200px;"/>
            </div>
        </div>
    </div>
</asp:Content>
