<%@ Page Title="" Language="C#" MasterPageFile="~/SHARED/MP.Master" AutoEventWireup="true" CodeBehind="THIRDSTATUS.aspx.cs" Inherits="DOAN_NQV.USER.THIRDSTATUS" %>
            ...
            <div class="statusNAME" style="font-family:Tahoma;font-size:19px;text-decoration:none;margin-left:250px;height:40px;background-color:rgba(0, 0, 0, 0.26);width:950px;">
               <asp:LinkButton ID="LinkButton1" runat="server"  href="DSDATHANG.aspx" class="tenTT" style="padding-right:100px;padding-left:38px;color:#111111;">Chờ duyệt</asp:LinkButton>
                <asp:LinkButton ID="LinkButton6" runat="server"  href="SECONDSTATUS.aspx" class="tenTT" style="padding-right:100px;color:#111111;">Đã duyệt</asp:LinkButton>
                 <asp:LinkButton ID="LinkButton2" runat="server" href="THIRDSTATUS.aspx" class="tenTT" style="padding-right:100px;color:#111111;color:#FFCC66;">Đang vận chuyển</asp:LinkButton>
