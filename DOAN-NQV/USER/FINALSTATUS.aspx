<%@ Page Title="" Language="C#" MasterPageFile="~/SHARED/MP.Master" AutoEventWireup="true" CodeBehind="FINALSTATUS.aspx.cs" Inherits="DOAN_NQV.USER.FINALSTATUS" %>
...
<%--                <asp:LinkButton ID="LinkButton3" runat="server"  class="tenTT" style="padding-right:100px;color:#111111;">Thanh toán</asp:LinkButton>--%>
                ...
                <asp:LinkButton ID="LinkButton5" runat="server"  href="FINALSTATUS.aspx" class="tenTT" style="padding-right:10px;color:#111111;color:#FFCC66;">Hủy</asp:LinkButton>
              </div>
             </div>
            <div>
